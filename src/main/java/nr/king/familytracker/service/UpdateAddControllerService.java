...
import nr.king.familytracker.repo.UpdateAddControllerRepo;
...
@Service
public class UpdateAddControllerService {
    @Autowired
    ...
    private static final Logger logger = LogManager.getLogger(UpdateAddControllerService.class);
