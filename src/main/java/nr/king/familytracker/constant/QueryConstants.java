...
public class QueryConstants {
    ...
    public static final String GET_ALL_MESSAGES_WITH_USER_ID="SELECT ID,MESSAGE,MESSAGE_USER_ID,MESSAGE_IMAGE_URL,ADMIN_ID,CREATED_AT,UPDATED_AT,IS_SEEN," +
            "MESSAGER_ID FROM MESSAGE_BETWEEN_USER WHERE MESSAGER_ID=";
